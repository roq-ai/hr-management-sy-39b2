...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['owner', 'employee'], key: 'order_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['owner', 'employee'], key: 'inventory_id', tenantPath: [], userPath: [] },
  'payment_received.create': { roles: ['owner', 'employee'], key: 'payment_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'employee'];
